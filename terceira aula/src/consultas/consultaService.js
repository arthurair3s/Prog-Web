...
export const criar = (novaConsultaData) => {
  ...
  // Business Rule: Check if the doctor is busy at the same dataHora
...
export const atualizar = (id, consultaData) => {
  ...
  // Se estiver atualizando a dataHora ou medicoId, precisamos verificar a regra de negócio novamente
